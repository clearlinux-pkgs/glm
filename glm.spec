...
Source0  : https://github.com/g-truc/glm/releases/download/0.9.9.1/glm-0.9.9.1.zip
...
export LANG=C
export SOURCE_DATE_EPOCH=1536548536
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/include/glm/ext/scalar_float_sized.hpp
