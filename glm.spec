...
License  : MIT
Requires: glm-license = %{version}-%{release}
BuildRequires : buildreq-cmake
BuildRequires : glm-dev
# Suppress stripping binaries
%define __strip /bin/true
%define debug_package %{nil}
Patch1: backport-install.patch
...
%package license
Summary: license components for the glm package.
Group: Default

%description license
license components for the glm package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689347897
mkdir -p clr-build
pushd clr-build
...
export SOURCE_DATE_EPOCH=1689347897
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/glm
cp %{_builddir}/glm/copying.txt %{buildroot}/usr/share/package-licenses/glm/38421e8956b53147a3838f5a23e14de037d5396a || :
pushd clr-build
%make_install
popd
...
/usr/share/package-licenses/glm/38421e8956b53147a3838f5a23e14de037d5396a
